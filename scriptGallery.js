...
function loadGallery() {
    ...
    xhr.open("GET", "gallery1.html", true); // Muat galeri 1 saat tombol "Load Gallery" ditekan
...
function loadGalleryContent() {
    ...
    xhr.open("GET", "gallery" + currentGallery + ".html", true); // Muat galeri yang sedang aktif
    xhr.send(); // Kirim permintaan
}
